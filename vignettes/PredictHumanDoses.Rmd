...
The following sections show how to use the predictDose* functions to find doses that satisfy a minimum time above minimal inhibitory concentration (MIC) criterion and a minimum parasitemia reduction ratio (PRR) criterion.
