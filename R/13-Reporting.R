...
#'
#' @description Create LaTex ready strings of PK, PD and error parameters

#' @return Named list where the names are the non-LaTeX strings i.e. `Fabs0 = "F_{abs,0}"`
#' @export
...
#' table_strToLaTeX
#' @description Convert equations/parameters to LaTeX mode
...
#' generate_EstimateTableForReport
#' @description Generate a table of estimate from IQR or GPF output in a summarized format
#' @param projectPath IQR pr GPF project path
#' @param tableOutputPath optional string denoting location to write table, will attempt to default to provided projectPath if NULL 
...
#'
#' @description Read a covariate summary table in .txt format as generated by 
#' IQRtools, restructure it into a tidier format and save it
#' @param tableInputPath String denoting path to IQRtable .txt file saved with `IQRtools::IQRoutputTable()`
#' @param tableOutputPath Optional string denoting location to write table, will attempt to default to provided tableInputPath if NULL
#' @param report Logical, TRUE: add reporting tags FALSE: do not add (for screen output only) 
#' NULL: same as TRUE if xtable provided. Default: TRUE
#' @param Function Default: function(x) {
#'    gsub("MODEL_", "", x)
#'}
#' @export
#' @author Mohammed H. Cherkaoui (MMV, \email{cherkaouim@@mmv.org})
...
#'
#' @description Read two PK models in .txt format as generated by 
#' IQRtools, combine and compare them. 
#' @param tableInputPath1 String denoting path to IQRtable .txt file saved with `IQRtools::IQRoutputTable()`
#' @param tableInputPath2 String denoting path to IQRtable .txt file saved with `IQRtools::IQRoutputTable()`
#' @param tableOutputPath Optional string denoting location to write table, will 
#' attempt to default to provided tableInputPath1 and tableInputPath2 if NULL. (Default: `NULL`).
#' @param renameMODEL Optional function to rename combined model output (Default: `NULL`).
#' @param addDescription Optional function to add description to combined model output (Default: `NULL`).
#' @param Metric Which metric (OBJ, BIC, AIC) to compare and arrange models with. Default: 'BIC'
#' @param xTitle Optional string for adding title to output table (Default: `NULL`).
#' @param xFooter Optional string for adding footer to output table (Default: `NULL`).
#' @param report Logical, TRUE: add reporting tags FALSE: do not add 
#' (for screen output only) NULL: same as TRUE if xtable provided.Default: TRUE
#' @export
#' @author Mohammed H. Cherkaoui (MMV, \email{cherkaouim@@mmv.org})
#' @family Reporting
...
#' @description Read a PK model in .txt format as generated by 
#' IQRtools, restructure it into a tidier format and save it
#' @param tableInputPath String denoting path to IQRtable .txt file saved with `IQRtools::IQRoutputTable()`
#' @param tableOutputPath (Default: `NULL`).
#' @param colToAdd Character vector denoting which columns should be included in 
#' the output table. Default: c("Nr. of Compartments", "Clearance", "Absorption", "Time Lag",
#'    "Error Model")
#' @param Metric Which metric (OBJ, BIC, AIC) to compare and arrange models with. Default: 'BIC'
#' @param xTitle Optional string for adding title to output table (Default: `NULL`).
#' @param xFooter Optional string for adding footer to output table (Default: `NULL`).
...
#' reportText_convertListToText
#' @description Convert list input to text string 
#' @param list list to convert
#' @param sepWord Character string to separate elements of list

#' @return Combined character string
#' @export
#' @author Unknown
#' @family Reporting
...
#' @return Character string of PK models to test 
#' @export
#' @author Unknown
#' @family Reporting
